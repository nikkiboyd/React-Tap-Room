        ...
        <div>
            <div className="row">
                ...
                <hr/>
                    ...
                    <h4 style={question}>Can I order beer directly from Ecliptic Brewing?</h4>
                        We wish we could but due to state and federal distribution laws, Ecliptic Brewing cannot sell or ship beers to consumers over the phone or via the internet.
                    ...
                    <h4 style={question}>Is Ecliptic Brewing going to expand distribution to the East Coast or Eastern Canada?</h4>
                        Ecliptic Brewing is slowly expanding eastward as capacity allows so we can supply the freshest beer to our customers.

                    <h4 style={question}>I heard Ecliptic Brewing is owned by (insert name of large domestic brewery here), is this true?</h4>
                        Ecliptic Brewing has always been family owned and operated. An Employee Stock Ownership Program (ESOP) was set up in 2013 so employees now own a percentage of the company. “We are not owned by, or selling to, any large brewer or other entity, nor do we have any plans to. We’re having too much fun to change.” — Gary Fish, Founder and President.

                    <h4 style={question}>Are Ecliptic Brewing beers vegan?</h4>
